...
class FurnituresControllerTest < ActionController::TestCase
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post :create, furniture: { category: @furniture.category, delivery: @furniture.delivery, description: @furniture.description, image: @furniture.image, price: @furniture.price, shop_id: @furniture.shop_id, stock: @furniture.stock, title: @furniture.title }
    end
  ...
  test "should update furniture" do
    patch :update, id: @furniture, furniture: { category: @furniture.category, delivery: @furniture.delivery, description: @furniture.description, image: @furniture.image, price: @furniture.price, shop_id: @furniture.shop_id, stock: @furniture.stock, title: @furniture.title }
    assert_redirected_to furniture_path(assigns(:furniture))
  end
